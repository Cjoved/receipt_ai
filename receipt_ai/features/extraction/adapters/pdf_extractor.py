...
class PdfExtractor(Extractor):
    ...
    def _extract_vision(self, request: ExtractionRequest) -> str:
        ...
        page_pngs = render_pdf_pages_to_png_bytes(request.file_bytes, self._config.pdf_max_pages, self._config.pdf_render_dpi)
        if not page_pngs:
        ...
        if retries > 0 and skipped:
            for attempt in range(1, retries + 1):
                ...
                retry_pngs = render_pdf_pages_to_png_bytes(request.file_bytes, self._config.pdf_max_pages, retry_dpi)
